...
func (n *NoLock) Lock(_ context.Context, _ string, _ *token2.ID, _ string, _ bool) (string, error) {
	return "", nil
}

func (n *NoLock) UnlockIDs(_ context.Context, _ string, ids ...*token2.ID) []*token2.ID {
	return ids
}
