...
func (fake *FakeQueryEngine) PublicParamsByHash(arg1 context.Context, arg2 driver.PPHash) ([]byte, error) {
...
func (fake *FakeQueryEngine) PublicParamsByHashCallCount() int {
...
func (fake *FakeQueryEngine) PublicParamsByHashCalls(stub func(context.Context, driver.PPHash) ([]byte, error)) {
	fake.publicParamsByHashMutex.Lock()
	defer fake.publicParamsByHashMutex.Unlock()
	fake.PublicParamsByHashStub = stub
}

func (fake *FakeQueryEngine) PublicParamsByHashArgsForCall(i int) (context.Context, driver.PPHash) {
	fake.publicParamsByHashMutex.RLock()
	defer fake.publicParamsByHashMutex.RUnlock()
...
func (fake *FakeQueryEngine) PublicParamsByHashReturns(result1 []byte, result2 error) {
	fake.publicParamsByHashMutex.Lock()
	defer fake.publicParamsByHashMutex.Unlock()
...
func (fake *FakeQueryEngine) PublicParamsByHashReturnsOnCall(i int, result1 []byte, result2 error) {
	fake.publicParamsByHashMutex.Lock()
	defer fake.publicParamsByHashMutex.Unlock()
	fake.PublicParamsByHashStub = nil
...
func (fake *FakeQueryEngine) PublicParamsHashes(arg1 context.Context) ([]driver.PPHash, error) {
...
func (fake *FakeQueryEngine) PublicParamsHashesCallCount() int {
...
func (fake *FakeQueryEngine) PublicParamsHashesCalls(stub func(context.Context) ([]driver.PPHash, error)) {
	fake.publicParamsHashesMutex.Lock()
	defer fake.publicParamsHashesMutex.Unlock()
	fake.PublicParamsHashesStub = stub
}

func (fake *FakeQueryEngine) PublicParamsHashesArgsForCall(i int) context.Context {
	fake.publicParamsHashesMutex.RLock()
	defer fake.publicParamsHashesMutex.RUnlock()
...
func (fake *FakeQueryEngine) PublicParamsHashesReturns(result1 []driver.PPHash, result2 error) {
	fake.publicParamsHashesMutex.Lock()
	defer fake.publicParamsHashesMutex.Unlock()
...
func (fake *FakeQueryEngine) PublicParamsHashesReturnsOnCall(i int, result1 []driver.PPHash, result2 error) {
	fake.publicParamsHashesMutex.Lock()
	defer fake.publicParamsHashesMutex.Unlock()
	fake.PublicParamsHashesStub = nil
